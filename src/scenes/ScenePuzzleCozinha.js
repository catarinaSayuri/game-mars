// Cena do puzzle de cozinha para adicionar cacau, parte do minigame da Casa de Frank
export default class ScenePuzzleCozinhaCacau extends Phaser.Scene {
    constructor() {
        super("ScenePuzzleCozinhaCacau"); // Define a cena com chave única
    }

    // Configurações fixas da cena
    CONFIG = {
        FUNDO: { ESCALA: 0.8 }, // Escala do fundo do popup
        SETA: { ESCALA: 0.06, VELOCIDADE: 500 }, // Escala e velocidade da seta
        ...
        TEXTOS: {
            INSTRUCAO: {
                TEXTO: "ADICIONE A QUANTIDADE NECESSÁRIA DE CACAU PARA DARMOS CONTINUIDADE NA RECEITA!", // Instrução do puzzle
        ...
        ASSETS: {
            FUNDO: "src/assets/imagens/imagesPopUps/popUpCacau.png", // Fundo do popup
    ...
    preload() {
        this.load.image("imagemFundoPuzzle", this.CONFIG.ASSETS.FUNDO); // Carrega o fundo
    ...
    adicionarFundo() {
        this.popupTutorial = this.add.image(
            ...
            'imagemFundoPuzzle' // Imagem do fundo
    ...
    irParaProximaFase() {
        this.scene.start("ScenePuzzleCozinhaManteiga"); // Inicia a próxima cena
    }
