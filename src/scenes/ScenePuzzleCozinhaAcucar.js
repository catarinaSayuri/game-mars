// Cena do puzzle de cozinha para adicionar açúcar, parte do minigame da Casa de Frank
export default class ScenePuzzleCozinhaAcucar extends Phaser.Scene {
    constructor() {
        super("ScenePuzzleCozinhaAcucar"); // Define a cena com chave única
    }

    // Configurações fixas da cena
    CONFIG = {
        FUNDO: { ESCALA: 0.8 }, // Escala do fundo do popup
        SETA: { ESCALA: 0.06, VELOCIDADE: 700 }, // Escala e velocidade da seta
        ...
        TEXTOS: {
            INSTRUCAO: {
                TEXTO: "ADICIONE A QUANTIDADE NECESSÁRIA DE AÇUCAR PARA DARMOS CONTINUIDADE NA RECEITA!", // Instrução do puzzle
        ...
        ASSETS: {
            FUNDO: "src/assets/imagens/imagesPopUps/popUpAcucar.png", // Fundo do popup
    ...
    preload() {
        this.load.image("imagemFundoPuzzleAcucar", this.CONFIG.ASSETS.FUNDO); // Carrega o fundo
    ...
    adicionarFundo() {
        this.popupTutorial = this.add.image(
            ...
            'imagemFundoPuzzleAcucar' // Imagem do fundo
    ...
    irParaProximaFase() {
        this.scene.start("ScenePuzzleCozinhaFinal"); // Inicia a próxima cena
    }
